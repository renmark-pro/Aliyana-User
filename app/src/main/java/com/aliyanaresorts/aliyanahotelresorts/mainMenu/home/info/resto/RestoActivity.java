...
import static com.aliyanaresorts.aliyanahotelresorts.network.API.keyMenuResto;
...
public class RestoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new RestoAdapter(arrayList, this);
...
//        }));
    ...
    private void getDetail() {
        ...
        StringRequest strReq = new StringRequest(Request.Method.GET, keyMenuResto, new Response.Listener<String>() {
