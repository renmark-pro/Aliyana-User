...
public class MyBookingDetailList {

    private String kode_booking, tipe, jml_kamar, tgl_checkin, tgl_checkout, total_tagihan,
        terbayarkan, hutang, status;

    public MyBookingDetailList(String kode_booking, String tipe, String jml_kamar, String tgl_checkin, String tgl_checkout, String total_tagihan, String terbayarkan, String hutang, String status) {
