...
import static com.aliyanaresorts.aliyanahotelresorts.service.database.API.KEY_BUG;
...
public class BugActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                closeKeyboard(BugActivity.this);
    ...
    private void kirim(final View v, final String nama, final String email, final String isi) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, KEY_BUG,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        loading.dismiss();
                        Toast.makeText(BugActivity.this, error.getMessage(), Toast.LENGTH_LONG).show();
