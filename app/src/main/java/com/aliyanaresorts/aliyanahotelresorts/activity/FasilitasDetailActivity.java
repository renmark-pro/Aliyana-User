...
public class FasilitasDetailActivity extends AppCompatActivity {
    ...
    private void setSlide() {
        RequestQueue requestQueueS = Volley.newRequestQueue(FasilitasDetailActivity.this);
        ...
        StringRequest stringRequestS = new StringRequest(Request.Method.GET, KEY_FASILITAS_DETAIL+getIntentData(this,"posisi"),
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(FasilitasDetailActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
