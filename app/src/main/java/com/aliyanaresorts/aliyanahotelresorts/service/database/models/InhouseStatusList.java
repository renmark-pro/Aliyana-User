...
public class InhouseStatusList {

    private String id, kode_booking, jml_kamar, total, tgl_checkin, tgl_checkout, status;

    public InhouseStatusList(String id, String kode_booking, String jml_kamar, String total, String tgl_checkin, String tgl_checkout, String status) {
        this.id = id;
